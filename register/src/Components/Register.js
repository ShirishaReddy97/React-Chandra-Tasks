...
function Register(props) {
  ...
  const Registration=(e)=>{
    e.preventDafault();
    debugger;
    const data1={Email :data.Email,Password: data.Password,EmployeeName: data.EmployeeName,e, City: data.City,Department: data.Department};
...
<div class="col-sm-6">
  <input type="Password" name="Password" onChange={onChange} value={data.Password} class="form-control" id="exampleLastName" placeholder="Password" />  
                 ...
                 <div class="form-group">
                  ...
                  <button type="submit" class="btn btn-primary  btn-block">  Create Use
                  </button>
                  <hr />
                  </form>
                  <hr/>
